...
using REGON.Responses.FullData.Enums;
using REGON.Responses.FullData.Enums.AddressParameters;
using REGON.Responses.FullData.Enums.AddressParameters.Names;
using REGON.Responses.FullData.Enums.AddressParameters.Symbols;
using REGON.Responses.FullData.Enums.Contacts;
using REGON.Responses.FullData.Enums.Dates;
using REGON.Responses.FullData.Enums.Registers;
using REGON.Responses.FullData.Enums.Registers.FormaFinansowania;
using REGON.Responses.FullData.Enums.Registers.FormaPrawna.Podstawowa;
using REGON.Responses.FullData.Enums.Registers.FormaPrawna.Szczegolna;
using REGON.Responses.FullData.Enums.Registers.FormaWlasnosci;
using REGON.Responses.FullData.Enums.Registers.OrganRejestrowy;
using REGON.Responses.FullData.Enums.Registers.OrganZalozycielski;
using REGON.Responses.FullData.Enums.Registers.RodzajRejestru;
using System.Xml.Serialization;

namespace REGON.Responses.FullData
{
    public record FullDataResponse
    {
