...
using RegonPlugin.Responses.Raporty.Jednostki.Enums;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.AddressParameters;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.AddressParameters.Names;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.AddressParameters.Symbols;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Contacts;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Dates;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers.FormaFinansowania;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers.FormaPrawna.Podstawowa;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers.FormaPrawna.Szczegolna;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers.FormaWlasnosci;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers.OrganRejestrowy;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers.OrganZalozycielski;
using RegonPlugin.Responses.Raporty.Jednostki.Enums.Registers.RodzajRejestru;
...
namespace RegonPlugin.Responses.Raporty.Jednostki
{
    public record RaportJednostki
    {
        ...
        [XmlElement(ElementName = "lokfiz_regon14")] // lokfiz_regon9
